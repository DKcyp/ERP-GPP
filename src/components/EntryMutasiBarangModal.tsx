...
const EntryMutasiBarangModal: React.FC<EntryMutasiBarangModalProps> = ({
  isOpen,
  onClose,
}) => {
    ...
    <div className="fixed inset-0 bg-gray-600 bg-opacity-75 flex justify-center items-center p-4 z-50">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex justify-end p-6 border-t border-gray-200 space-x-3">
          ...
          <button className="px-6 py-2 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-colors duration-200 text-sm shadow-md">
            Simpan
          </button>
        </div>
      </div>
