...
import FinancePermintaanPencairanDanaModal, {
  PermintaanPencairanDanaFormData,
} from "./FinancePermintaanPencairanDanaModal";
...
const FinancePengajuanVoucherDashboard: React.FC = () => {
  ...
  const [modalTitle, setModalTitle] = useState("Tambah Pencairan Dana Voucher");
  const [editingData, setEditingData] =
    useState<PermintaanPencairanDanaFormData | null>(null);
  ...
  const [rows, setRows] = useState<VoucherRow[]>([
    {
      id: 1,
      tanggal: "2025-09-05",
      noPPD: "VCH-2025-09-001",
      divisi: "Marketing",
      pemohon: "Andi",
      keperluanUmum: "Voucher perjalanan dinas Jakarta",
      bank: "Bank Mandiri Operasional - 1400098765432",
      total: 2500000,
      pertanggungjawaban: "Iya",
      status: "Submitted",
    },
    {
      id: 2,
      tanggal: "2025-09-06",
      noPPD: "VCH-2025-09-002",
      divisi: "HRD",
      pemohon: "Siti",
      keperluanUmum: "Voucher training karyawan",
      bank: "Bank BCA Training - 5551234567890",
      total: 3500000,
    ...
    },
    {
      id: 3,
      tanggal: "2025-09-07",
      noPPD: "VCH-2025-09-003",
      divisi: "GA",
      pemohon: "Rudi",
      keperluanUmum: "Voucher maintenance gedung",
      bank: "Bank Mandiri GA - 1400055512345",
      total: 1800000,
      pertanggungjawaban: "Iya",
      status: "Pending",
    },
  ...
  const handleAdd = () => {
    setEditingData(null);
    setModalTitle("Tambah Pencairan Dana Voucher");
    setIsModalOpen(true);
  };
  ...
  const handleEdit = (row: VoucherRow) => {
    ...
    setEditingData(data);
    setModalTitle("Edit Pencairan Dana Voucher");
    setIsModalOpen(true);
  };

  const handleSave = (data: PermintaanPencairanDanaFormData) => {
    const tanggalStr = data.tglPPDFrom
      ? data.tglPPDFrom.toISOString().split("T")[0]
  ...
  const filtered = useMemo(() => {
    return rows.filter((r) => {
      const okNo = searchNo
        ? r.noPPD.toLowerCase().includes(searchNo.toLowerCase())
        : true;
      ...
      return (
        okNo && okPemohon && okDivisi && okStatus && okDateFrom && okDateTo
      );
    });
  }, [
    rows,
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-7 gap-6 mb-6">
            <div>
              ...
              <input
                ...
                placeholder="VCH-..."
                className="block w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-purple-500 focus:border-purple-500 text-sm"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
            ...
            <div>
              ...
              <select
                ...
                className="block w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-purple-500 focus:border-purple-500 text-sm appearance-none"
              >
            ...
            <div className="flex items-end">
              <button
                ...
                className="inline-flex items-center justify-center w-full px-4 py-2.5 text-sm font-medium rounded-lg shadow-sm text-white bg-purple-600 hover:bg-purple-700 focus:outline-none h-[42px]"
              >
      ...
      <ConfirmDeleteModal
        ...
        message="Apakah Anda yakin ingin menghapus Pencairan Dana Voucher ini?"
      />
    </div>
  );
};
