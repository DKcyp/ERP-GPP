...
const GudangDashboard: React.FC = () => {
  const data = [
    { no: 1, noPO: 'PO001', noFaktur: 'F001', tglFaktur: '10-02-2024', vendor: 'PT. Safety Indonesia', penerima: 'Muh Reza' },
    { no: 2, noPO: 'PO002', noFaktur: 'F002', tglFaktur: '11-02-2024', vendor: 'CV. Jaya Mandiri', penerima: 'Rizky Ramadhan' },
    { no: 3, noPO: 'PO003', noFaktur: 'F003', tglFaktur: '12-02-2024', vendor: 'PT. Makmur Sejahtera', penerima: 'Fajar Prasetyo' },
    { no: 4, noPO: 'PO004', noFaktur: 'F004', tglFaktur: '13-02-2024', vendor: 'CV. Berkah Abadi', penerima: 'Dina Kartika' },
    { no: 5, noPO: 'PO005', noFaktur: 'F005', tglFaktur: '14-02-2024', vendor: 'PT. Sumber Rezeki', penerima: 'Bagus Saputra' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            ...
            <div>
              <label htmlFor="no-faktur" className="block text-sm font-medium text-gray-700 mb-1">Cari No Faktur</label>
              <div className="relative">
                <input
                  type="text"
                  id="no-faktur"
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {data.map((row) => (
                  <tr key={row.no} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{row.noFaktur}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{row.tglFaktur}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{row.vendor}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{row.penerima}</td>
