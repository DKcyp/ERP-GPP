...
const sampleData: Row[] = [
  { no: 'PR-2025-001', namaBarang: 'Baut M10', jumlah: 100, tanggal: '2025-08-30', status: 'Proses' },
  { no: 'PR-2025-002', namaBarang: 'Cat Epoxy', jumlah: 25, tanggal: '2025-08-27', status: 'Approved' },
  { no: 'PR-2025-003', namaBarang: 'Masker N95', jumlah: 300, tanggal: '2025-08-25', status: 'Draft' },
];
...
const MonitoringPRDashboard: React.FC = () => {
  ...
  const [form, setForm] = useState<Row>({ no: '', namaBarang: '', jumlah: 0, tanggal: '', status: 'Draft' });
  ...
  const openAdd = () => {
    setEditing(null);
    setForm({ no: '', namaBarang: '', jumlah: 0, tanggal: '', status: 'Draft' });
    setShowForm(true);
  };
  ...
  const saveForm = () => {
    if (editing) {
      ...
      // if no provided, generate simple no
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-gradient-to-r from-blue-50 to-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 py-8 flex items-center justify-between">
          <div>
            <h1 className="text-4xl font-bold text-gray-900 tracking-wide mb-2">MONITORING PURCHASE REQUEST (PR)</h1>
            <nav className="text-sm text-gray-600">QHSE › Monitoring › PR</nav>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 mb-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
            <div className="md:col-span-2">
              <label className="block text-sm font-medium text-gray-700 mb-2">Cari No. PR / Nama Barang</label>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden">
              <div className="flex items-center justify-between p-6 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-white">
                <h2 className="text-xl font-bold text-gray-900">{editing ? 'Edit PR' : 'Tambah PR'}</h2>
        ...
        <ConfirmDeleteModal
          ...
          message="Apakah Anda yakin ingin menghapus data PR ini?"
          itemName={deleteTarget ? `${deleteTarget.no} - ${deleteTarget.namaBarang}` : undefined}
        />
      </div>
    </div>
  );
...
export default MonitoringPRDashboard;
