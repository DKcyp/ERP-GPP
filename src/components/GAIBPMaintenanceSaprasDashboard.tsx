...
import { Search, Plus, FileSpreadsheet, FileText, Clock, Edit, Trash2, Calendar, Building } from 'lucide-react';
...
const GAIBPMaintenanceSaprasDashboard: React.FC = () => {
  // Filters
  ...
  const filtered = useMemo(() => {
    ...
    return data.filter(d => {
      ...
      const matchStatus = status ? d.status === (status as MaintenanceItem['status']) : true;
      ...
      <div className="bg-gradient-to-r from-blue-100 via-blue-50 to-white border-b border-blue-100">
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-4xl font-bold text-gray-900 tracking-wide mb-2">MAINTENANCE SARANA & PRASARANA</h1>
              <nav className="text-sm text-gray-600">
                <span className="hover:text-blue-600 cursor-pointer transition-colors">GA</span>
                <span className="mx-2">›</span>
                <span className="text-blue-600 font-semibold">Maintenance Sarana & Prasarana</span>
              </nav>
            </div>
...
export default GAIBPMaintenanceSaprasDashboard;
