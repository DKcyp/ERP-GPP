...
const seed: RekonKeluaranItem[] = [
  { id: "rk-001", tanggal: "2025-09-02", noFaktur: "010.002-22.55555555", npwp: "03.456.789.0-123.000", nama: "PT Alpha", dpp: 200_000_000, ppn: 20_000_000, keterangan: "Inv 789" },
  { id: "rk-002", tanggal: "2025-09-07", noFaktur: "010.002-22.44444444", npwp: "04.567.890.1-234.000", nama: "PT Beta", dpp: 50_000_000, ppn: 5_000_000 },
];

const FinancePajakRekonsiliasiKeluaranDashboard: React.FC = () => {
  const [q, setQ] = useState("");
  const [show, setShow] = useState("10");
  const [rows] = useState<RekonKeluaranItem[]>(seed);
  ...
  const sum = (key: keyof RekonKeluaranItem) => pageData.reduce((s, r) => s + (Number(r[key]) || 0), 0);
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-gradient-to-r from-blue-50 to-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 py-6 flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 tracking-wide">Laporan Pajak Rekonsiliasi Keluaran</h1>
            <div className="text-xs text-gray-600">Finance › Pajak › Rekonsiliasi Keluaran</div>
          </div>
...
export default FinancePajakRekonsiliasiKeluaranDashboard;
