  ...
  const [records, setRecords] = useState<DoseRecord[]>([
    {
      ...
      validation: "07-03-2021 / 07-03-2021",
      documentNo: "GBP-HSE-FM-20",
      revisionNo: "05",
      dateOfRevision: "07-03-2021",
      dateOfEffective: "07-03-2021",
      page: "1 of 1",
      doseData: {
        "2021": {
          "Jan-Mar": 0,
        ...
        "2024": { "Jan-Mar": 0, "Apr-Jun": 0, "Jul-Sep": 0, "Oct-Dec": 0.06 },
        "2025": {
          "Jan-Mar": 0.7,
          "Apr-Jun": null,
          "Jul-Sep": null,
  ...
  const handleSave = () => {
    ...
    if (modalMode === "add") {
      const newRecord: DoseRecord = {
        ...
        dateOfRevision: formData.dateOfRevision || "07-03-2021",
        dateOfEffective: formData.dateOfEffective || "07-03-2021",
          ...
          <tbody>
            ...
            <tr style="background-color: #f0f0f0;">
              ...
              ${years
                .map(
                  (year) =>
                    `<td><strong>${record.totalByYear[year] || 0}</strong></td>`
                )
                .join("")}
            </tr>
          </tbody>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-yellow-600">
                  {(
                    records.reduce(
                      (sum, r) => sum + (r.totalByYear[selectedYear] || 0),
                      0
                    ) / records.length
                  ).toFixed(2)}{" "}
                  mSv
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleInputChange("sibNo", e.target.value)
                        }
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <div className="space-y-6">
                  ...
                  <div className="border border-gray-300">
                    <div className="bg-gray-100 p-4 border-b border-gray-300">
                      <div className="grid grid-cols-3 gap-4">
                        ...
                        <div className="space-y-1 text-sm">
                          <div className="flex">
                            <span className="w-24">Document No.</span>
                            <span>{selectedRecord.documentNo}</span>
                          </div>
                          <div className="flex">
                            <span className="w-24">Revision No.</span>
                            <span>{selectedRecord.revisionNo}</span>
                          </div>
                          <div className="flex">
                            <span className="w-24">Date of Revision</span>
                            <span>{selectedRecord.dateOfRevision}</span>
                          </div>
                          <div className="flex">
                            <span className="w-24">Date of Effective</span>
                            <span>{selectedRecord.dateOfEffective}</span>
                          </div>
                          <div className="flex">
                    ...
                    <div className="p-4 space-y-2 text-sm">
                      ...
                      <div className="flex">
                        <span className="w-24 font-medium">Qualification</span>
                        <span>: {selectedRecord.qualification}</span>
                      </div>
                      <div className="flex">
                        <span className="w-24 font-medium">SIB No.</span>
                        <span>: {selectedRecord.sibNo}</span>
                      </div>
                      <div className="flex">
                        <span className="w-24 font-medium">Validation</span>
                        <span>: {selectedRecord.validation}</span>
                      </div>
                    </div>

                    {/* Dose Evaluation Table */}
                    <div className="p-4">
                      <h4 className="text-center font-bold mb-4 bg-gray-200 py-2">
                        Hasil Evaluasi Dosis (mSv)
                      </h4>
                      <div className="overflow-x-auto">
                        <table className="w-full border border-gray-300 text-sm">
                          <thead>
                            <tr className="bg-gray-100">
                              <th className="border border-gray-300 px-3 py-2 text-center font-bold w-12">
                                No. Urut
                              </th>
                              <th className="border border-gray-300 px-3 py-2 text-center font-bold">
                                Periode
                          ...
                          <tbody>
                            {months.map((month, index) => (
                              <tr key={month}>
                                ...
                                {years.map((year) => {
                                  const value =
                                    selectedRecord.doseData[year]?.[month];
                                  return (
                                    <td
                                      key={`${year}-${month}`}
                                      className="border border-gray-300 px-3 py-2 text-center"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-white rounded-xl shadow-2xl border border-gray-200 w-full max-w-md p-6">
            ...
            <p className="text-gray-600 mb-6">
              Apakah Anda yakin ingin menghapus kartu dosis untuk{" "}
              <strong>{recordToDelete.name}</strong>? Tindakan ini tidak dapat
              dibatalkan.
            </p>
