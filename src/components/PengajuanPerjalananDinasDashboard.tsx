...
const PengajuanPerjalananDinasDashboard: React.FC = () => {
  const [data, setData] = useState<TripItem[]>([
    ...
    },
    {
      ...
      attachmentUrl:
        "https://file-examples.com/storage/fe1d6b1a0ec/example.xlsx",
      zona: "Zona 3",
    },
  ]);
  ...
  const filtered = data.filter((d) => {
    ...
    const matchZona = d.zona
      ? d.zona.toLowerCase().includes(searchZona.toLowerCase())
      : true;
    const withinDate = (() => {
    ...
    return matchNama && matchTujuan && matchZona && withinDate;
  });
  ...
  const openEdit = (item: TripItem) => {
    ...
    setForm({
      ...
      zona: item.zona || "Zona 1", // Default zona
    });
    setShowFormModal(true);
  };
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-6 py-6 space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden">
              <div className="flex items-center justify-between p-6 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-white">
                <h2 className="text-xl font-bold text-gray-900">
                  {editingItem
                    ? "Edit Pengajuan Perjalanan Dinas"
                    : "Tambah Pengajuan Perjalanan Dinas"}
                </h2>
                <button
                  onClick={() => {
                    setShowFormModal(false);
              ...
              <div className="p-6 space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="block w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-blue-500 focus:border-blue-500 text-sm"
                  >
                    {Array.from({ length: 10 }, (_, i) => `Zona ${i + 1}`).map(
                      (zona) => (
        ...
        <ConfirmDeleteModal
          ...
          itemName={
            deleteTarget
              ? `${deleteTarget.namaPegawai} - ${deleteTarget.tujuan}`
              : undefined
          }
        />
      </div>
