...
const bankMeta: Array<{ namaBank: string; norek: string; alamat: string }> = [
  { namaBank: 'Bank Muamalat', norek: '1234567890', alamat: 'Jl. Jend. Sudirman No. 1, Jakarta' },
  { namaBank: 'Bank Mandiri Gaji', norek: '1400012345678', alamat: 'KCP Mandiri Gaji, Jl. Gatot Subroto, Jakarta' },
  { namaBank: 'Bank Mandiri Operasional', norek: '1400098765432', alamat: 'KCP Mandiri Operasional, Jl. MH Thamrin, Jakarta' },
  { namaBank: 'Bank Mandiri Tabungan', norek: '1400076543210', alamat: 'KCP Mandiri Tabungan, Jl. Asia Afrika, Bandung' },
  { namaBank: 'Bank Mandiri PPN', norek: '1400055512345', alamat: 'KCP Mandiri Pajak, Jl. Jend. Sudirman, Jakarta' },
  { namaBank: 'Bank Mandiri Vendor', norek: '1400033345678', alamat: 'KCP Mandiri Vendor, Jl. Pemuda, Jakarta' },
  { namaBank: 'Bank Mandiri Kesejahteraan', norek: '1400022245678', alamat: 'KCP Mandiri Kesejahteraan, Jl. Diponegoro, Surabaya' },
  { namaBank: 'Bank Mandiri Zakat', norek: '1400099912345', alamat: 'KCP Mandiri Zakat, Jl. Asia Afrika, Bandung' },
  { namaBank: 'Bank BCA', norek: '8888888888', alamat: 'KCU BCA, Jl. Jend. Sudirman, Jakarta' },
];

const FinanceLaporanBankHarianDashboard: React.FC = () => {
  ...
  const [rows] = useState<BankRow[]>([
    { id: 1, namaBank: 'Bank Muamalat', norek: '1234567890', alamat: 'Jl. Jend. Sudirman No. 1, Jakarta', saldoAwal: 8000000, bankMasuk: 2500000, bankKeluar: 1000000 },
    { id: 2, namaBank: 'Bank Mandiri Gaji', norek: '1400012345678', alamat: 'KCP Mandiri Gaji, Jl. Gatot Subroto, Jakarta', saldoAwal: 12000000, bankMasuk: 5000000, bankKeluar: 3000000 },
    { id: 3, namaBank: 'Bank Mandiri Operasional', norek: '1400098765432', alamat: 'KCP Mandiri Operasional, Jl. MH Thamrin, Jakarta', saldoAwal: 10000000, bankMasuk: 4000000, bankKeluar: 2500000 },
    { id: 4, namaBank: 'Bank Mandiri Tabungan', norek: '1400076543210', alamat: 'KCP Mandiri Tabungan, Jl. Asia Afrika, Bandung', saldoAwal: 6000000, bankMasuk: 1500000, bankKeluar: 1000000 },
    { id: 5, namaBank: 'Bank Mandiri PPN', norek: '1400055512345', alamat: 'KCP Mandiri Pajak, Jl. Jend. Sudirman, Jakarta', saldoAwal: 7000000, bankMasuk: 2000000, bankKeluar: 1500000 },
    { id: 6, namaBank: 'Bank Mandiri Vendor', norek: '1400033345678', alamat: 'KCP Mandiri Vendor, Jl. Pemuda, Jakarta', saldoAwal: 9000000, bankMasuk: 3000000, bankKeluar: 2200000 },
    { id: 7, namaBank: 'Bank Mandiri Kesejahteraan', norek: '1400022245678', alamat: 'KCP Mandiri Kesejahteraan, Jl. Diponegoro, Surabaya', saldoAwal: 5000000, bankMasuk: 1200000, bankKeluar: 800000 },
    { id: 8, namaBank: 'Bank Mandiri Zakat', norek: '1400099912345', alamat: 'KCP Mandiri Zakat, Jl. Asia Afrika, Bandung', saldoAwal: 3000000, bankMasuk: 900000, bankKeluar: 400000 },
    { id: 9, namaBank: 'Bank BCA', norek: '8888888888', alamat: 'KCU BCA, Jl. Jend. Sudirman, Jakarta', saldoAwal: 11000000, bankMasuk: 3500000, bankKeluar: 2700000 },
  ]);
  ...
  const totals = useMemo(() => {
    ...
    return { totalSaldoAwal, totalMasuk, totalKeluar, totalSaldoAkhir };
  }, [rows]);
      ...
      <div className="bg-gradient-to-r from-blue-50 to-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-4xl font-bold text-gray-900 tracking-wide mb-2">LAPORAN BANK HARIAN</h1>
              <nav className="text-sm text-gray-600">
                <span className="hover:text-blue-600 cursor-pointer transition-colors">Finance</span>
                <span className="mx-2">›</span>
                <span className="text-blue-600 font-medium">Bank / Laporan Bank Harian</span>
              </nav>
            </div>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {rows.map((row, idx) => {
                  const saldoAkhir = row.saldoAwal + row.bankMasuk - row.bankKeluar;
                  return (
                    <tr key={row.id}>
              ...
              <tfoot className="bg-gray-50">
                <tr>
                  <td className="px-6 py-3 text-sm font-semibold text-gray-900 text-right" colSpan={7}>Total Saldo Akhir</td>
...
export default FinanceLaporanBankHarianDashboard;
