...
const PerjanjianIkatanDinasDashboard: React.FC = () => {
  const [data, setData] = useState<IkatanDinasData[]>([
    {
      ...
      namaTraining: "Training IT Fundamental",
      hargaTraining: "Rp 5.000.000",
    },
  ]);
  ...
  const [form, setForm] = useState<IkatanDinasForm>({
    namaPegawai: "",
    nomorPerjanjian: "",
    tanggal: "",
    periode: "",
  ...
  const [itemToDelete, setItemToDelete] = useState<IkatanDinasData | null>(
    null
  );
  ...
  const filtered = useMemo(() => {
    ...
    return data.filter(
      (d) =>
        ...
        d.nomorPerjanjian.toLowerCase().includes(s) ||
  ...
  const openEditModal = (item: IkatanDinasData) => {
    ...
    setForm({
      ...
      file: null,
      namaTraining: item.namaTraining || "",
      hargaTraining: item.hargaTraining || "",
    });
    setIsEditMode(true);
    setIsFormOpen(true);
  };
  ...
  const handleSave = (e: React.FormEvent) => {
    ...
    if (isEditMode && editingItem) {
        ...
        prev.map((d) =>
          d.id === editingItem.id
            ? {
                ...d,
                ...form,
                status: form.status as IkatanDinasData["status"],
      ...
      const nextNo =
        data.length > 0 ? Math.max(...data.map((x) => x.no)) + 1 : 1;
      setData((prev) => [
        {
          id: Date.now().toString(),
          no: nextNo,
          namaPegawai: form.namaPegawai,
          nomorPerjanjian: form.nomorPerjanjian,
          ...
          fileName,
          fileUrl,
          namaTraining: form.namaTraining,
          hargaTraining: form.hargaTraining,
        },
        ...prev,
      ]);
    }
  ...
  const confirmDelete = (item: IkatanDinasData) => {
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mb-6">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="inline-flex items-center gap-2 bg-cyan-600 hover:bg-cyan-700 text-white px-3 py-2 rounded-md text-sm font-medium"
              >
          ...
          <div className="w-full max-w-2xl rounded-lg bg-white shadow-xl">
            <div className="flex items-center justify-between border-b px-6 py-4">
              <h3 className="text-lg font-semibold text-gray-900">
                {isEditMode ? "Edit Perjanjian" : "Tambah Perjanjian"}
              </h3>
              <button
            ...
            <form onSubmit={handleSave} className="px-6 py-5 space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    value={form.nomorPerjanjian}
                    onChange={(e) =>
                      setForm((p) => ({
                        ...p,
                        nomorPerjanjian: e.target.value,
                      }))
                    }
                    className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:ring-2 focus:ring-cyan-500 focus:border-transparent"
                    required
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm((p) => ({ ...p, namaTraining: e.target.value }))
                    }
                    className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:ring-2 focus:ring-cyan-500 focus:border-transparent"
                  />
                </div>
                <div>
                  ...
                  <input
                    value={form.hargaTraining}
                    onChange={(e) =>
                      setForm((p) => ({ ...p, hargaTraining: e.target.value }))
                    }
                    className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:ring-2 focus:ring-cyan-500 focus:border-transparent"
                    placeholder="Rp 0"
                  />
