...
import { TandaTerimaPODariGudangData } from '../types'; // Import the new interface
...
const GudangPenerimaanDashboard: React.FC = () => {
  ...
  const [periodeStart, setPeriodeStart] = useState('03/03/2025');
  const [periodeEnd, setPeriodeEnd] = useState('03/03/2025');
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={(e) => setSearchNoFaktura(e.target.value)}
              />
              <Search className="absolute left-3 top-1/2 translate-y-1/2 h-5 w-5 text-gray-400 pointer-events-none" />
            </div>
            {/* Cari Nama Vendor */}
