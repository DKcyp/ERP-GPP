...
const GAUtilityDashboard: React.FC = () => {
  // Filters
  ...
  const [deleteTarget, setDeleteTarget] = useState<UtilityItem | null>(null);
  ...
  const filtered = useMemo(() => {
    ...
    return data.filter(d => {
      ...
      const matchDue = (!from || due >= from) && (!to || due <= to);

      return matchText && matchJenis && matchStatus && matchPeriode && matchDue;
    });
  }, [data, searchLokasi, jenisFilter, statusFilter, periode, dueFrom, dueTo]);
      ...
      <div className="bg-gradient-to-r from-blue-100 via-blue-50 to-white border-b border-blue-100">
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-4xl font-bold text-gray-900 tracking-wide mb-2">MONITORING UTILITY</h1>
              <nav className="text-sm text-gray-600">
                <span className="hover:text-blue-600 cursor-pointer transition-colors">GA</span>
                <span className="mx-2">›</span>
                <span className="text-blue-600 font-semibold">Monitoring Utility</span>
              </nav>
            </div>
            ...
            <div className="space-y-2 lg:col-span-2">
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="Contoh: Kantor Pusat / PLN"
                />
...
export default GAUtilityDashboard;
