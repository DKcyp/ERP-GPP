...
const FinanceKasBankEntryDashboard: React.FC = () => {
  ...
  const [editingLineItem, setEditingLineItem] = useState<TransactionLineItem | null>(null);
  ...
  const [detailFormData, setDetailFormData] = useState<DetailTransactionForm>({
    noTransaksi: 'AFDk-2025090001',
    tanggalTransaksi: '2025-09-01',
    diberikanKepada: 'I GEDE RYANTA PUTRA ARSANA',
    keterangan: 'Jurnal Penyeimbang Pertanggungjawaban dengan No Dokumen PT.AFMA-2025/1158 dan No Jurnal AFMA-2025090001',
    lineItems: [
      {
        id: 1,
        kodeUT: '05',
  ...
  const [entries, setEntries] = useState<KasBankEntry[]>([
    ...
    { 
      ...
      tanggal: '28-08-2025', 
      nomorBukti: 'AFDk-2025080307', 
      keterangan: 'Beban peralatan pembukaan pekerjaan HK Pekanbaru Agustus 2025', 
      jumlah: 0, 
      namaPengguna: 'ARIO SETYO N', 
  ...
  const filteredEntries = useMemo(() => {
    return entries.filter(entry => {
      const matchesNomorBukti = !nomorBukti || entry.nomorBukti.toLowerCase().includes(nomorBukti.toLowerCase());
  ...
  const handleLanjut = () => {
    ...
    console.log('Filter applied:', { periodeTanggalAwal, periodeTanggalAkhir, nomorBukti });
  };
  ...
  const handleDetailFormSubmit = () => {
    if (isEditMode && editingEntry) {
      ...
      const updatedEntry: KasBankEntry = {
        ...
        jumlah: detailFormData.lineItems.reduce((sum, item) => sum + item.debet + item.kredit, 0),
  ...
  const handleDetailInputChange = (field: keyof DetailTransactionForm, value: string) => {
    setDetailFormData(prev => ({
      ...prev,
      [field]: value
    }));
  ...
  const calculateTotals = () => {
    const totalDebet = detailFormData.lineItems.reduce((sum, item) => sum + item.debet, 0);
    const totalKredit = detailFormData.lineItems.reduce((sum, item) => sum + item.kredit, 0);
    ...
    if (editingLineItem) {
      setDetailFormData(prev => ({
        ...
        lineItems: prev.lineItems.map(lineItem => 
          lineItem.id === editingLineItem.id 
            ? { ...editingLineItem }
            : lineItem
        )
      }));
  ...
  const handleEditLineItemChange = (field: keyof TransactionLineItem, value: string | number) => {
    if (editingLineItem) {
      setEditingLineItem({
        ...editingLineItem,
        [field]: value
      ...
      <div style="font-family: Arial, sans-serif; padding: 20px;">
        ...
        <table style="width: 100%; border-collapse: collapse;">
          <tr>
            ...
            <td style="padding: 8px; border: 1px solid #ddd;">${entry.nomorBukti}</td>
          </tr>
          <tr>
            <td style="padding: 8px; border: 1px solid #ddd; font-weight: bold;">Tanggal:</td>
            <td style="padding: 8px; border: 1px solid #ddd;">${entry.tanggal}</td>
          </tr>
          <tr>
            <td style="padding: 8px; border: 1px solid #ddd; font-weight: bold;">Keterangan:</td>
            <td style="padding: 8px; border: 1px solid #ddd;">${entry.keterangan}</td>
          </tr>
          <tr>
            <td style="padding: 8px; border: 1px solid #ddd; font-weight: bold;">Jumlah:</td>
            <td style="padding: 8px; border: 1px solid #ddd;">${formatCurrency(entry.jumlah)}</td>
          </tr>
          <tr>
            <td style="padding: 8px; border: 1px solid #ddd; font-weight: bold;">Nama Pengguna:</td>
            <td style="padding: 8px; border: 1px solid #ddd;">${entry.namaPengguna}</td>
          </tr>
          <tr>
            <td style="padding: 8px; border: 1px solid #ddd; font-weight: bold;">Waktu Entry:</td>
            <td style="padding: 8px; border: 1px solid #ddd;">${entry.entriRealTime}</td>
          </tr>
        </table>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {paginatedEntries.map((entry) => (
                <tr key={entry.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3 text-sm text-gray-900 max-w-xs truncate" title={entry.keterangan}>
                    {entry.keterangan}
                  </td>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl mx-4">
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200">
              <h2 className="text-lg font-semibold text-gray-900">Transaksi Kas / Bank Entry</h2>
              <button
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => handleInputChange('kasBank', e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleInputChange('tanggalTransaksi', e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleInputChange('diberikanKepada', e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => handleDetailInputChange('noTransaksi', e.target.value)}
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      readOnly
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => handleDetailInputChange('tanggalTransaksi', e.target.value)}
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleDetailInputChange('diberikanKepada', e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) => handleDetailInputChange('keterangan', e.target.value)}
                    rows={2}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                </div>
                    ...
                    <table className="w-full border border-gray-300">
                      <thead className="bg-gray-50 a">
                        <tr>
                          ...
                          <th className="px-2 py-2 text-left text-xs font-medium text-gray-500 uppercase border-r border-gray-300">Kode COA</th>
                          <th className="px-2 py-2 text-left text-xs font-medium text-gray-500 uppercase border-r border-gray-300">Nama Akun</th>
                          <th className="px-2 py-2 text-left text-xs font-medium text-gray-500 uppercase border-r border-gray-300">Keterangan</th>
                          <th className="px-2 py-2 text-left text-xs font-medium text-gray-500 uppercase border-r border-gray-300">Debet</th>
                          <th className="px-2 py-2 text-left text-xs font-medium text-gray-500 uppercase">Kredit</th>
                        </tr>
                      </thead>
                      <tbody>
                        {detailFormData.lineItems.map((item) => (
                          <tr key={item.id} className="border-b border-gray-200">
                            ...
                            <td className="px-2 py-2 text-sm border-r border-gray-300">{item.kode}</td>
                            <td className="px-2 py-2 text-sm border-r border-gray-300">{item.namaAkun}</td>
                            <td className="px-2 py-2 text-sm border-r border-gray-300">{item.keterangan}</td>
                        ...
                        <tr className="bg-gray-50 font-semibold">
                          <td colSpan={5} className="px-2 py-2 text-right border-r border-gray-300">Total</td>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-semibold text-gray-900">Edit Line Item</h3>
              <button
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => handleEditLineItemChange('kode', e.target.value)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => handleEditLineItemChange('namaAkun', e.target.value)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => handleEditLineItemChange('keterangan', e.target.value)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleEditLineItemChange('debet', parseFloat(e.target.value) || 0)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleEditLineItemChange('kredit', parseFloat(e.target.value) || 0)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                </div>
              </div>
