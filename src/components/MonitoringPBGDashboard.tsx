...
const sampleData: Row[] = [
  { no: 'PBG-2025-001', namaBarang: 'Electrode E7018', jumlah: 200, status: 'Approved' },
  { no: 'PBG-2025-002', namaBarang: 'Grinding Wheel 4"', jumlah: 50, status: 'Proses' },
  { no: 'PBG-2025-003', namaBarang: 'Safety Glasses', jumlah: 30, status: 'Draft' },
];
...
const MonitoringPBGDashboard: React.FC = () => {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-blue-50 to-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 py-8 flex items-center justify-between">
          <div>
            <h1 className="text-4xl font-bold text-gray-900 tracking-wide mb-2">MONITORING PBG</h1>
            <nav className="text-sm text-gray-600">QHSE › Monitoring Gudang › PBG</nav>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 mb-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
            <div className="md:col-span-2">
              <label className="block text-sm font-medium text-gray-700 mb-2">Cari No. PBG / Nama Barang</label>
...
export default MonitoringPBGDashboard;
