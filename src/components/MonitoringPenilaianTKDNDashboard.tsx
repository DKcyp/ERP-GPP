...
const MonitoringPenilaianTKDNDashboard: React.FC = () => {
  const initialData: PenilaianTKDNItem[] = [
    {
      id: "PTKDN-001",
      noKontrak: "KTR-2025-0007",
      judulTender: "Pengadaan Peralatan X",
      documentUrl: "#",
    },
    {
      id: "PTKDN-002",
      noKontrak: "KTR-2025-0011",
      judulTender: "Jasa Perawatan Tahunan",
      documentUrl: "#",
    },
  ];
  ...
  const [form, setForm] = useState<Omit<PenilaianTKDNItem, "id">>({
    noKontrak: "",
    judulTender: "",
    documentUrl: "#",
  ...
  const [deleteTarget, setDeleteTarget] = useState<PenilaianTKDNItem | null>(
    null
  );
  ...
  const openAdd = () => {
    setEditing(null);
    setForm({ noKontrak: "", judulTender: "", documentUrl: "#", documentName: undefined });
    setShowForm(true);
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50">
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-blue-600">
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        download={it.documentName || "dokumen_tkdn"}
                        className="flex items-center hover:underline"
                      >
                        <FileText className="h-4 w-4 mr-1" /> {it.documentName ? "Download" : "Lihat"}
                      </a>
                    </td>
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden">
            <div className="flex items-center justify-between p-6 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-white">
              <h2 className="text-xl font-bold text-gray-900">
                {editing ? "Edit Penilaian TKDN" : "Tambah Penilaian TKDN"}
              </h2>
              <button
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm((f) => ({ ...f, noKontrak: e.target.value }))
                    }
                    className="block w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-blue-500 focus:border-blue-500"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm((f) => ({ ...f, judulTender: e.target.value }))
                    }
                    className="block w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-blue-500 focus:border-blue-500"
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (file) {
                      ...
                      setForm((f) => ({ ...f, documentUrl: url, documentName: file.name }));
                    } else {
                      setForm((f) => ({ ...f, documentUrl: "#", documentName: undefined }));
                    }
                  }}
                  className="block w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-blue-500 focus:border-blue-500"
                />
                {form.documentName && (
                  <p className="text-xs text-gray-500 mt-1">Terpilih: {form.documentName}</p>
                )}
              </div>
            </div>
      ...
      <ConfirmDeleteModal
        ...
        itemName={
          deleteTarget
            ? `${deleteTarget.noKontrak} - ${deleteTarget.judulTender}`
            : undefined
        }
      />
    </div>
