...
import KontrakPegawaiModal, {
  KontrakPegawaiFormData,
} from "./KontrakPegawaiModal";
...
const KontrakPegawaiDashboard: React.FC = () => {
  ...
  const [sortField, setSortField] = useState<keyof KontrakPegawaiRow | null>(
    null
  );
  ...
  const [initialModalData, setInitialModalData] =
    useState<Partial<KontrakPegawaiFormData> | null>(null);

  const [deleteModalOpen, setDeleteModalOpen] = useState(false);
  const [itemToDelete, setItemToDelete] = useState<KontrakPegawaiRow | null>(
    null
  );
                ...
                {currentData.map((item, index) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-sm text-gray-900 max-w-md">
                      <div className="truncate" title={item.renewalKontrak}>
                        {item.renewalKontrak}
                      </div>
                    </td>
