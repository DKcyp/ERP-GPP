...
const ApprovalVoucherDashboard: React.FC = () => {
  ...
  const [selectedVoucherDetail, setSelectedVoucherDetail] =
    useState<ApprovalVoucherDetailData | null>(null);

  // State for Payment Method Modal
  const [isPaymentModalOpen, setIsPaymentModalOpen] = useState(false);
  const [selectedVoucherForPayment, setSelectedVoucherForPayment] =
    useState<ApprovalVoucherDetailData | null>(null);
  ...
  const kasOptions = [
    {
      ...
      location: "Kantor Pusat - Lantai 2",
      balance: 5000000,
    },
    {
      id: "kas-002",
      name: "Kas Proyek Site A",
      location: "Site A - Container Office",
      balance: 3000000,
    },
    {
      id: "kas-003",
      name: "Kas Proyek Site B",
      location: "Site B - Field Office",
      balance: 2500000,
    },
  ];
  ...
  const bankOptions = [
    {
      ...
      account: "1400098765432",
      branch: "KCP Mandiri Operasional",
      balance: 150000000,
    },
    {
      id: "bank-002",
      name: "Bank BCA Operasional",
      account: "5430012345678",
      branch: "KCP BCA Sudirman",
      balance: 85000000,
    },
    {
      id: "bank-003",
      name: "Bank BNI Payroll",
      account: "0987654321098",
      branch: "KCP BNI Gatot Subroto",
      balance: 45000000,
    },
  ];
  ...
  const handleConfirmPayment = () => {
    ...
    if (selectedVoucherForPayment && selectedOption) {
      ...
      alert(
        `Pembayaran berhasil!\n\nVoucher: ${
          selectedVoucherForPayment.noVoucher
        }\nMetode: ${paymentMethod === "kas" ? "Kas" : "Bank"}\nDetail: ${
          selectedOption.name
        }\nTanggal Bayar: ${new Date(paymentDate).toLocaleDateString(
          "id-ID"
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-hidden">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-purple-100 text-sm mt-1">
                    ...
                    {formatCurrency(selectedVoucherForPayment.jumlahNominal)}
                  </p>
                </div>
                <button
            ...
            <div className="p-6">
              ...
              <div className="mb-6">
                ...
                >
                  <option value="">
                    -- Pilih {paymentMethod === "kas" ? "Kas" : "Bank"} --
                  </option>
                  {(paymentMethod === "kas" ? kasOptions : bankOptions).map(
                    (option) => (
                      <option key={option.id} value={option.id}>
                        {option.name} -{" "}
                        {"account" in option ? option.account : option.location}
                  ...
                  {(() => {
                    ...
                    return selectedOption ? (
                      <div className="text-sm text-gray-600">
                        <p>
                          <strong>Nama:</strong> {selectedOption.name}
                        </p>
                        <p>
                          <strong>
                            {"account" in selectedOption
                              ? "No. Rekening"
                              : "Lokasi"}
                            :
                          </strong>{" "}
                        ...
                        {"branch" in selectedOption && (
                          <p>
                            <strong>Cabang:</strong> {selectedOption.branch}
                          </p>
                        )}
                        <p>
                        ...
                        <p>
                          ...
                          {new Date(paymentDate).toLocaleDateString("id-ID")}
                        </p>
                      </div>
                    ) : null;
                  })()}
