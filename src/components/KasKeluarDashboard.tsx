...
import { Clock, PlusCircle, Save, Trash2, Search, Filter, FileSpreadsheet, FileDown, Pencil, CalendarDays, Edit } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <ConfirmDeleteModal
        ...
        message="Apakah Anda yakin ingin menghapus transaksi kas keluar ini?"
      />
    </div>
  );
};
