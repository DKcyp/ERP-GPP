...
interface SIBData {
  ...
  namaPegawai: string;
  nomorSurat: string;
  tanggalTerbit: string; // YYYY-MM-DD (Masa Berlaku - Tgl Awal)
  berlakuSampai: string; // YYYY-MM-DD (Masa Berlaku - Tgl Akhir)
...
const SuratIzinBekerjaDashboard: React.FC = () => {
  ...
  const [form, setForm] = useState<SIBForm>({
    namaPegawai: "",
    nomorSurat: "",
    tanggalTerbit: "",
    berlakuSampai: "",
        ...
        prev.map((d) =>
          d.id === editingItem.id
            ? {
                ...d,
                ...form,
                status: form.status as SIBData["status"],
      ...
      setData((prev) => [
        {
          ...
          berlakuSampai: form.berlakuSampai,
          status: form.status as SIBData["status"],
  ...
  const confirmDelete = (item: SIBData) => {
              ...
              <tbody className="divide-y divide-gray-200">
                {currentData.map((item, index) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-sm text-gray-900">
                      {item.tanggalTerbit} - {item.berlakuSampai}
                    </td>
          ...
          <div className="w-full max-w-2xl rounded-lg bg-white shadow-xl">
            <div className="flex items-center justify-between border-b px-6 py-4">
              <h3 className="text-lg font-semibold text-gray-900">
                {isEditMode ? "Edit Surat" : "Tambah Surat"}
              </h3>
              <button
            ...
            <form onSubmit={handleSave} className="px-6 py-5 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    value={form.telp}
                    onChange={(e) =>
                      setForm((p) => ({ ...p, telp: e.target.value }))
                    }
                    className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:ring-2 focus:ring-cyan-500 focus:border-transparent"
                  />
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm((p) => ({ ...p, nomorSurat: e.target.value }))
                    }
                    className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:ring-2 focus:ring-cyan-500 focus:border-transparent"
                    required
                  />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    Masa Berlaku - Tgl Awal
                  </label>
                  <input
                    type="date"
                    value={form.tanggalTerbit}
                    onChange={(e) =>
                      setForm((p) => ({ ...p, tanggalTerbit: e.target.value }))
                    }
                    className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:ring-2 focus:ring-cyan-500 focus:border-transparent"
                    required
                  />
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    Masa Berlaku - Tgl Akhir
                  </label>
                  <input
                    type="date"
                    value={form.berlakuSampai}
                    onChange={(e) =>
                      setForm((p) => ({ ...p, berlakuSampai: e.target.value }))
                    }
                    className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:ring-2 focus:ring-cyan-500 focus:border-transparent"
                    required
                  />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm((p) => ({ ...p, kualifikasi: e.target.value }))
                    }
                    className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:ring-2 focus:ring-cyan-500 focus:border-transparent"
                  />
                </div>
