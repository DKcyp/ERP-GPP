            ...
            <table className="min-w-full border-collapse border border-gray-300">
              <thead>
                <tr className="bg-gray-100">
                  ...
                  <th className="border border-gray-300 px-3 py-2 text-xs font-medium text-gray-700 text-center" colSpan={2}>
                    SAFETY GLASS CLEAR
                  </th>
                  <th className="border border-gray-300 px-3 py-2 text-xs font-medium text-gray-700 text-center" colSpan={2}>
                    SAFETY GLASS DARK
              ...
              <tbody>
                {paginatedData.map((record) => (
                  <tr key={record.id} className="hover:bg-gray-50">
                    ...
                    {/* Safety Glass Clear */}
                    <td className={`border border-gray-300 px-2 py-2 text-sm text-center ${getStatusColor(record.safetyGlassClear.status)}`}>
                      {record.safetyGlassClear.tanggal}
                    </td>
                    <td className="border border-gray-300 px-2 py-2 text-sm text-center">
                      {record.safetyGlassClear.jumlah}
                    </td>
                    {/* Safety Glass Dark */}
                    <td className={`border border-gray-300 px-2 py-2 text-sm text-center ${getStatusColor(record.safetyGlassDark.status)}`}>
                      {record.safetyGlassDark.tanggal}
                    </td>
                    <td className="border border-gray-300 px-2 py-2 text-sm text-center">
                      {record.safetyGlassDark.jumlah}
                    </td>
                    {/* Halfmask Respirator */}
                    <td className={`border border-gray-300 px-2 py-2 text-sm text-center ${getStatusColor(record.halfmaskRespirator.status)}`}>
                      {record.halfmaskRespirator.tanggal}
                    </td>
                    <td className="border border-gray-300 px-2 py-2 text-sm text-center">
                      {record.halfmaskRespirator.jumlah}
                    </td>
                    {/* Full Mask Respirator */}
                    <td className={`border border-gray-300 px-2 py-2 text-sm text-center ${getStatusColor(record.fullMaskRespirator.status)}`}>
                      {record.fullMaskRespirator.tanggal}
                    </td>
                    <td className="border border-gray-300 px-2 py-2 text-sm text-center">
                      {record.fullMaskRespirator.jumlah}
                    </td>
                    {/* Safety Goggle */}
                    <td className={`border border-gray-300 px-2 py-2 text-sm text-center ${getStatusColor(record.safetyGoggle.status)}`}>
                      {record.safetyGoggle.tanggal}
                    </td>
                    <td className="border border-gray-300 px-2 py-2 text-sm text-center">
                      {record.safetyGoggle.jumlah}
                    </td>
                    {/* Actions */}
                    <td className="border border-gray-300 px-2 py-2 text-sm text-center">
          ...
          <div className="relative top-10 mx-auto p-5 border max-w-4xl shadow-lg rounded-md bg-white">
            ...
            <form className="space-y-6 max-h-96 overflow-y-auto">
              ...
              <div className="border rounded-lg p-4 bg-green-50">
                <h4 className="font-medium text-gray-900 mb-3">Safety Glasses</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {/* Safety Glass Clear */}
                  <div className="space-y-4">
                    <h5 className="font-medium text-gray-800">Safety Glass Clear</h5>
                    <div className="grid grid-cols-1 gap-4">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Tanggal</label>
                        <input
                          type="date"
                          value={formData.safetyGlassClear?.tanggal || ''}
                          onChange={(e) => setFormData(prev => ({
                            ...prev,
                            safetyGlassClear: { ...prev.safetyGlassClear, tanggal: e.target.value }
                          }))}
                          disabled={modalMode === 'view'}
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100"
                        />
                      ...
                      <div>
                        ...
                        <input
                          type="number"
                          min="0"
                          value={formData.safetyGlassClear?.jumlah || ''}
                          onChange={(e) => setFormData(prev => ({
                            ...prev,
                            safetyGlassClear: { ...prev.safetyGlassClear, jumlah: parseInt(e.target.value) || 0 }
                          }))}
                          disabled={modalMode === 'view'}
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100"
                        />
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Status</label>
                        <select
                          value={formData.safetyGlassClear?.status || ''}
                          onChange={(e) => setFormData(prev => ({
                            ...prev,
                            safetyGlassClear: { ...prev.safetyGlassClear, status: e.target.value as 'Valid' | 'Mendekati Expired' | 'Expired' }
                          }))}
                          disabled={modalMode === 'view'}
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100"
                        >
                  ...
                  {/* Safety Glass Dark */}
                  <div className="space-y-4">
                    <h5 className="font-medium text-gray-800">Safety Glass Dark</h5>
                    <div className="grid grid-cols-1 gap-4">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Tanggal</label>
                        <input
                          type="date"
                          value={formData.safetyGlassDark?.tanggal || ''}
                          onChange={(e) => setFormData(prev => ({
                            ...prev,
                            safetyGlassDark: { ...prev.safetyGlassDark, tanggal: e.target.value }
                          }))}
                          disabled={modalMode === 'view'}
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100"
                        />
                      ...
                      <div>
                        ...
                        <input
                          type="number"
                          min="0"
                          value={formData.safetyGlassDark?.jumlah || ''}
                          onChange={(e) => setFormData(prev => ({
                            ...prev,
                            safetyGlassDark: { ...prev.safetyGlassDark, jumlah: parseInt(e.target.value) || 0 }
                          }))}
                          disabled={modalMode === 'view'}
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100"
                        />
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Status</label>
                        <select
                          value={formData.safetyGlassDark?.status || ''}
                          onChange={(e) => setFormData(prev => ({
                            ...prev,
                            safetyGlassDark: { ...prev.safetyGlassDark, status: e.target.value as 'Valid' | 'Mendekati Expired' | 'Expired' }
                          }))}
                          disabled={modalMode === 'view'}
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100"
                        >
              ...
              <div className="border rounded-lg p-4 bg-yellow-50">
                <h4 className="font-medium text-gray-900 mb-3">Respirators</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {/* Halfmask Respirator */}
                  <div className="space-y-4">
                    <h5 className="font-medium text-gray-800">Halfmask Respirator</h5>
                    <div className="grid grid-cols-1 gap-4">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Tanggal</label>
                        <input
                          type="date"
                          value={formData.halfmaskRespirator?.tanggal || ''}
                          onChange={(e) => setFormData(prev => ({
                            ...prev,
                            halfmaskRespirator: { ...prev.halfmaskRespirator, tanggal: e.target.value }
                          }))}
                          disabled={modalMode === 'view'}
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100"
                        />
                      ...
                      <div>
                        ...
                        <input
                          type="number"
                          min="0"
                          value={formData.halfmaskRespirator?.jumlah || ''}
                          onChange={(e) => setFormData(prev => ({
                            ...prev,
                            halfmaskRespirator: { ...prev.halfmaskRespirator, jumlah: parseInt(e.target.value) || 0 }
                          }))}
                          disabled={modalMode === 'view'}
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100"
                        />
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Status</label>
                        <select
                          value={formData.halfmaskRespirator?.status || ''}
                          onChange={(e) => setFormData(prev => ({
                            ...prev,
                            halfmaskRespirator: { ...prev.halfmaskRespirator, status: e.target.value as 'Valid' | 'Mendekati Expired' | 'Expired' }
                          }))}
                          disabled={modalMode === 'view'}
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100"
                        >
                  ...
                  {/* Full Mask Respirator */}
                  <div className="space-y-4">
                    <h5 className="font-medium text-gray-800">Full Mask Respirator</h5>
                    <div className="grid grid-cols-1 gap-4">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Tanggal</label>
                        <input
                          type="date"
                          value={formData.fullMaskRespirator?.tanggal || ''}
                          onChange={(e) => setFormData(prev => ({
                            ...prev,
                            fullMaskRespirator: { ...prev.fullMaskRespirator, tanggal: e.target.value }
                          }))}
                          disabled={modalMode === 'view'}
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100"
                        />
                      ...
                      <div>
                        ...
                        <input
                          type="number"
                          min="0"
                          value={formData.fullMaskRespirator?.jumlah || ''}
                          onChange={(e) => setFormData(prev => ({
                            ...prev,
                            fullMaskRespirator: { ...prev.fullMaskRespirator, jumlah: parseInt(e.target.value) || 0 }
                          }))}
                          disabled={modalMode === 'view'}
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100"
                        />
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Status</label>
                        <select
                          value={formData.fullMaskRespirator?.status || ''}
                          onChange={(e) => setFormData(prev => ({
                            ...prev,
                            fullMaskRespirator: { ...prev.fullMaskRespirator, status: e.target.value as 'Valid' | 'Mendekati Expired' | 'Expired' }
                          }))}
                          disabled={modalMode === 'view'}
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100"
                        >
              ...
              <div className="border rounded-lg p-4 bg-purple-50">
                <h4 className="font-medium text-gray-900 mb-3">Safety Goggle</h4>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Tanggal</label>
                    <input
                      type="date"
                      value={formData.safetyGoggle?.tanggal || ''}
                      onChange={(e) => setFormData(prev => ({
                        ...prev,
                        safetyGoggle: { ...prev.safetyGoggle, tanggal: e.target.value }
                      }))}
                      disabled={modalMode === 'view'}
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100"
                    />
                  ...
                  <div>
                    ...
                    <input
                      type="number"
                      min="0"
                      value={formData.safetyGoggle?.jumlah || ''}
                      onChange={(e) => setFormData(prev => ({
                        ...prev,
                        safetyGoggle: { ...prev.safetyGoggle, jumlah: parseInt(e.target.value) || 0 }
                      }))}
                      disabled={modalMode === 'view'}
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100"
                    />
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Status</label>
                    <select
                      value={formData.safetyGoggle?.status || ''}
                      onChange={(e) => setFormData(prev => ({
                        ...prev,
                        safetyGoggle: { ...prev.safetyGoggle, status: e.target.value as 'Valid' | 'Mendekati Expired' | 'Expired' }
                      }))}
                      disabled={modalMode === 'view'}
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100"
                    >
